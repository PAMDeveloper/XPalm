...
public:
    PlantView()
    {
        ...
        selector("BIOMASSE_PROD", artis::kernel::DOUBLE,{Tree::BIOMASSE_PROD});
        selector("BUNCH_BIOMASS", artis::kernel::DOUBLE,{Tree::BUNCH_BIOMASS});
        selector("BUNCH_DEMAND", artis::kernel::DOUBLE,{Tree::BUNCH_DEMAND});
        selector("DATE_PLUS_JEUNE_FEUILLE", artis::kernel::DOUBLE,{Tree::DATE_PLUS_JEUNE_FEUILLE});
        selector("DELTA_AVANT_CROISSANCE", artis::kernel::DOUBLE,{Tree::DELTA_AVANT_CROISSANCE});
        selector("DELTA_AV_RESPI", artis::kernel::DOUBLE,{Tree::DELTA_AV_RESPI});
        selector("EI", artis::kernel::DOUBLE,{Tree::EI});
        selector("FEMALE_BUNCH_BIOMASS", artis::kernel::DOUBLE,{Tree::FEMALE_BUNCH_BIOMASS});
        selector("FRACTION_POUR_CROISSANCE", artis::kernel::DOUBLE,{Tree::FRACTION_POUR_CROISSANCE});
        selector("FRUIT_DEMAND", artis::kernel::DOUBLE,{Tree::FRUIT_DEMAND});
        selector("FR_AVANT_CROISSANCE", artis::kernel::DOUBLE,{Tree::FR_AVANT_CROISSANCE});
        ...
        selector("INACTIVEPHYTOMERNUMBER", artis::kernel::DOUBLE,{Tree::INACTIVEPHYTOMERNUMBER});
        ...
        selector("NF", artis::kernel::DOUBLE,{Tree::NF});
        selector("OFFRE_FRUITS", artis::kernel::DOUBLE,{Tree::OFFRE_FRUITS});
        selector("OFFRE_NETTE", artis::kernel::DOUBLE,{Tree::OFFRE_NETTE});
        selector("OFFRE_POUR_CROISSANCE", artis::kernel::DOUBLE,{Tree::OFFRE_POUR_CROISSANCE});
        selector("OFFRE_POUR_RESPI", artis::kernel::DOUBLE,{Tree::OFFRE_POUR_RESPI});
        selector("OFFRE_RESTE", artis::kernel::DOUBLE,{Tree::OFFRE_RESTE});
        ...
        selector("PRODUCTIONSPEED", artis::kernel::DOUBLE,{Tree::PRODUCTIONSPEED});
        selector("PRODUCTION_DECREASE", artis::kernel::DOUBLE,{Tree::PRODUCTION_DECREASE});
        selector("RESPIRABLE_BUNCH_BIOMASS", artis::kernel::DOUBLE,{Tree::RESPIRABLE_BUNCH_BIOMASS});
        selector("SIMULATION", artis::kernel::DOUBLE,{Tree::SIMULATION});
        selector("SLW", artis::kernel::DOUBLE,{Tree::SLW});
        selector("TABMEMORISE", artis::kernel::DOUBLE,{Tree::TABMEMORISE});
