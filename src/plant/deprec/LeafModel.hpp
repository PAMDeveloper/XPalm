...
//        /** PHYTOMER_MODEL Defioliation --- A METTRE DANS LEAF **/
//        double DEBUT_DEFOLIATON = _parameters.get("DEBUT_DEFOLIATON");
//        double RANG_DEFOLIATON = _parameters.get("RANG_DEFOLIATON");
//        double POURC_DEFOLIATON = _parameters.get("POURC_DEFOLIATON");
//        if(step > DEBUT_DEFOLIATON) {
//            auto it = _phytomer_models.begin();
//            while (it != _phytomer_models.end()) {
//                PhytomerModel* phytomer = (*it);
//                if (phytomer->get < phytomer::phytomer_state, PhytomerModel >(t, PhytomerModel::PHYTOMER_STATE) == phytomer::ACTIVE &&
//                        phytomer->get < double, PhytomerModel >(t, PhytomerModel::RANK) > RANG_DEFOLIATON) {
...
//        }
    ...
    void init(double t,
              const xpalm::ModelParameters& parameters)
    {
        last_time = t-1;
