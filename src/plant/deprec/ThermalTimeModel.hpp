...
public:
    enum internals { TEFF
//        BOOL_CROSSED_PLASTO, BOOL_CROSSED_PHYLLO, BOOL_CROSSED_LIGULO,
...
//                     SLA, TEMP_DD, TEMP_DD_PHYLLO, TEMP_DD_LIGULO, DD, EDD, DD_PHYLLO, DD_LIGULO, EDD_PHYLLO, EDD_LIGULO
    ...
    enum externals {
//        DELTA_T, PLASTO_DELAY, PLASTO, PHYLLO, LIGULO, STOCK, IS_FIRST_CULM
    };

    ThermalTimeModel() {
        //    computed variables
        Internal(TEFF, &ThermalTimeModel::_Teff);
