...
//        internals
        ...
        a = min(TailleC1, (H_0 - H_PF_Z1 ) * Z1);
        qte_H2O_C1 = max(0., a );
        a = min(TailleVap , (H_0 - H_PF_Z1 ) * Z1 );
        qte_H2O_Vap = max (0., a);
        a = min(TailleC2, (H_0 - H_PF ) * Z2);
        qte_H2O_C2 = max(0., a);
        a = qte_H2O_C1 + qte_H2O_C2 - qte_H2O_Vap;
        qte_H2O_C = max(0., a);
        a = qte_H2O_C1 - qte_H2O_Vap;
        qte_H2O_C1moinsVap = max(0., a);
        qte_H2O_C1_Racines = qte_H2O_C1 * racines_TailleC1 / TailleC1;
        qte_H2O_Vap_Racines = qte_H2O_Vap * racines_TailleVap / TailleVap;
        qte_H2O_C2_Racines = qte_H2O_C2 * racines_TailleC2 / TailleC2;
        qte_H2O_C_Racines = qte_H2O_C * racines_TailleC / TailleC;
        qte_H2O_C1moinsVap_Racines = qte_H2O_C1moinsVap * racines_TailleC1moinsVap / TailleC1moinsVap;
        FractionC1 = 0;
        FractionC2 = 0;
        FractionC = 0;
        FractionC1Racine = 0;
...
//      compute_BH_Racines_apres_Evap
        a = qte_H2O_C1moinsVap_Racines - EvapC1moinsVap * racines_TailleC1moinsVap / TailleC1moinsVap;
        qte_H2O_C1moinsVap_Racines = max (0. , a);
        a = qte_H2O_Vap_Racines  - EvapVap * racines_TailleVap / TailleVap;
        qte_H2O_Vap_Racines = max(0., a);
